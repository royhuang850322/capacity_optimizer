...
REPORT_TEXTS: dict[str, dict[str, str]] = {
    ...
    "sheet_title_monthly_capacity": {
        "en": "Monthly Trend - {mode} | Max vs Planner",
        "zh": "月度趋势 - {mode} | Max 对比 Planner",
    },
...
SUBSTRING_VALUE_TRANSLATIONS_ZH: list[tuple[str, str]] = [
    ...
    ("Max vs Planner", "最大产能 对比 计划产能"),
    ("Max Load%", "最大产能负载率"),
    ("Planner Load%", "计划产能负载率"),
    ("Planner-basis", "计划产能口径"),
    ("Demand", "需求"),
    ("Demand 行", "需求行"),
    ("负载率 行", "负载率行"),
    ("planner 可追溯", "计划员可追溯"),
